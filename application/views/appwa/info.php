        ...
        <div class="content-wrapper">
          ...
          <div class="row"> 
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Penginputan Data User yang di wa</h4>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Text Chat</label>
                          <div class="col-sm-9">
                            <div class="input-group-prepend">
                              <span class="input-group-text"></span>
                              <textarea class="form-control" value="Terimakasih telah berkunjung" name="text" placeholder="teks"aria-describedby="basic-addon1"  required id="exampleTextarea1" rows="4"></textarea>
                                <!-- <input type="text" onfocus="this.placeholder = ''" class="form-control" id="exampleInputName1" name="text" placeholder="teks"aria-describedby="basic-addon1"  required> -->
                            </div>
                          </div>
                        </div>
                      </div>
                  </div>
                   <button type="submit" class="btn btn-success mr-2">Kirim Pesan</button>
                    </form>
                </div>
              </div>
            </div>
