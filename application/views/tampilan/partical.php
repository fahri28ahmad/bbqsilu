<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">  
          <a class="navbar-brand brand-logo" href="<?php echo base_url();?>"><img src="<?php echo base_url();?>aset/logo/silulogo250.png" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="<?php echo base_url();?>"><img src="<?php echo base_url();?>aset/logo/silulogo250.png" alt="logo"/></a>
...
<!-- modal box crop gambar -->
<div id="uploadimageModalUji" class="modal" tabindex="-1" role="dialog">
  <div class="modal-dialog" >
    <div class="modal-content ">
      ...
      <div class="modal-footer justify-content-center">
        <div class="row ">
          <button class="btn btn-success upload-result-uji mr-3">Upload Image</button>
          <button type="button" class="btn btn-success rotate_left_uji" data-deg="-90">Rotasi kiri</button>
        </div>
      </div>
    </div>
  </div>
