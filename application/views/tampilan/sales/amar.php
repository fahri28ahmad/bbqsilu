<?php $this->load->view("tampilan/sales/head/amar1")?>
  <body>
  <?php $this->load->view("tampilan/luar/nav_head")?>
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
        <li class="nav-item active"><a href="<?php echo base_url();?>amar" class="nav-link">Home</a></li>
    ...
    <div class="hero-wrap" style="background-image: url('<?php echo base_url();?>public/as/images/baru/asarni2.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay" style="background: #000000b0;"></div>
      <div class="overlay-2"></div>
      <div class="container">
        <div class="row no-gutters slider-text justify-content-center align-items-center">
          <div class="col-lg-8 col-md-6 ftco-animate d-flex align-items-end">
            <div class="text text-center w-100">
              <h2 style="font-family: tahoma;color:#ffffff;" class="mb-4"><b>PT. ASARNI MANDIRI PROPERTINDO</h2>
              <h3 style="font-family: tahoma;color:#ffffff;" class="mb-4">Kami sebagai spesialis property bergerak di bidang Tanah Kavling yang mengelola Kavling Anda secara Profesional, Amanah dan Menguntungkan.</h3>
              <h3 style="font-family: tahoma;color:#ffffff;" class="mb-4">Dengan memiliki kavling di Kawasan Pengembangan Kota Baru Kab.Gowa dengan 9 titik lokasi yang tersebar agar dapat mewujudkan investasi impian anda.</h3>
              <p><a href="https://wa.me/6285256594943?text=Halo%20.......%20Boleh%20Info%20*Tanah Kavlingnya%20 yang sedang di pasarkan?*" class="btn btn-primary py-3 px-4">Wa Sekarang</a></p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="property-wrap ftco-animate">
              <div class="img d-flex align-items-center justify-content-center" style="background-image: url(<?php echo base_url();?>public/as/images/SURVEYLOKASI/SURVEILOKASI1.jpg);">
                <!-- <a href="<?php echo base_url();?>home/properties2" class="icon d-flex align-items-center justify-content-center btn-custom">
                  <span class="ion-ios-link"></span>
                </a> -->
              </div>
              <div class="text">
                <H3 class="mb-0">FOTO SURVEY</H3>
                ...
                <ul class="property_list">
                  <li>Kunjungan lokasi langsung di beberapa titik lokasi kavling Asarni yang Strategis di kabupaten Gowa, Sulawesi Selatan</li>
                </ul>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="property-wrap ftco-animate">
              <div class="img d-flex align-items-center justify-content-center" style="background-image: url(<?php echo base_url();?>public/as/images/PENYERAHANshm/IKLAN031.jpg);">
                <<!-- a href="<?php echo base_url();?>home/properties1" class="icon d-flex align-items-center justify-content-center btn-custom">
                  <span class="ion-ios-link"></span>
                </a> -->
              </div>
              <div class="text">
                <H3 class="mb-0">FOTO PEYERAHAN</H3>
                ...
                <ul class="property_list">
                  <li>Pembelian Tanah Kavling Siap Bangun & Penyerahan Sertifikat Hak Milik oleh Tim Official Terbaik Kami<br></li>
          ...
          <div class="col-md-4">
            <div class="property-wrap ftco-animate">
              <div class="img d-flex align-items-center justify-content-center" style="background-image: url(<?php echo base_url();?>public/as/images/KAVLINGSIAPBANGUN/UFUY1.jpg);">
                <!-- <a href="<?php echo base_url();?>home/properties" class="icon d-flex align-items-center justify-content-center btn-custom">
                  <span class="ion-ios-link"></span>
                </a> -->
              </div>
              <div class="text">
                <H3 class="mb-0">FOTO LOKASI</H3>
                ...
                <ul class="property_list">
                  <li>Saat survey lokasi, anda dapat memilih ukuran kavling impian anda. Dari ukuran 102m2 sampai 160m2</li>
                  <!-- <li><span class="flaticon-bed"></span>3</li>
                  <li><span class="flaticon-bathtub"></span>2</li>
                  <li><span class="flaticon-floor-plan"></span>1,878 sqft</li> -->
                </ul>
                ...
                <div class="col-md-12 d-flex align-self-stretch ftco-animate">
                  <div class="media block-6 services-wrap d-flex">
                    ...
                    <div class="media-body pl-4">
                      ...
                      <p>Hanya dengan Rp 1.1 jt perbualan anda sudah bisa berinvestasi tanah kavling Eksklusif siap bangun.</p>
                    </div>
                  </div>      
                </div>
                <div class="col-md-12 d-flex align-self-stretch ftco-animate">
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap py-4">
                  <div class="text">
                    <p class="mb-4">terima kasih pak, Alhamdulillah saya ucapkan terima kasih kepada team, ngak nyesal beli kavling di sini, kalau ada rejeki nambah lagi,legalitas kavling Aman Dan terjamin.</p>
                    <div class="d-flex align-items-center">
                      <div class="user-img" style="background-image: url(<?php echo base_url();?>public/as/images/testimoni/a.jpg)"></div>
                      <div class="pl-3">
                        <p class="name">Andi ahdiar wahyudi</p>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  <div class="text">
                    <p class="mb-4">Alhamdulillah akhir nya saya bisa memiliki tanah kavling di Asarni mandiri Propertindo, proses akad sangat mudah, semoga semakin sukses Asarni mandiri  dan team.</p>
                    <div class="d-flex align-items-center">
                      <div class="user-img" style="background-image: url(<?php echo base_url();?>public/as/images/testimoni/b.jpg)"></div>
                      <div class="pl-3">
                        <p class="name">Nurhikmah Malik</p>
                        <!-- <span class="position">Marketing Manager</span> -->
                      </div>
                    </div>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  <div class="text">
                    <p class="mb-4">Terima kasih, saya sangat senang sekali bisa bekerja sama dengan pesona realty, saya bisa mewujudkan impian istri saya bisa beli tanah kavling di kavling Asarni mandiri karena kreditnya sangat murah dan terpercaya.</p>
                    <div class="d-flex align-items-center">
                      <div class="user-img" style="background-image: url(<?php echo base_url();?>public/as/images/testimoni/c.jpg)"></div>
                      <div class="pl-3">
                        <p class="name">Faisal Ahmad</p>
                        <!-- <span class="position">Marketing Manager</span> -->
                      </div>
                    </div>
                  </div>
...
<!--     <section class="ftco-section ftco-no-pt">
 ...
 <?php $this->load->view("tampilan/sales/footer/amar")?>
