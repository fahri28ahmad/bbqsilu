<?php $this->load->view("tampilan/sales/head/amar1")?>
  ...
  <?php $this->load->view("tampilan/luar/nav_head")?>
      <div class="collapse navbar-collapse" id="ftco-nav">
        ...
        <li class="nav-item active"><a href="<?php echo base_url();?>lelly" class="nav-link">Home</a></li>
    ...
    <div class="hero-wrap" style="background-image: url('<?php echo base_url();?>public/as/images/baru/leli.jpg');" data-stellar-background-ratio="0.5">
        ...
        <div class="row no-gutters slider-text justify-content-center align-items-center">
          <div class="col-lg-8 col-md-6 ftco-animate d-flex align-items-end">
            <div class="text text-center w-100">
              ...
              <p><a href="https://wa.me/6289510407019?text=Halo%20.......%20Boleh%20Info%20*Tanah Kavlingnya%20 yang sedang di pasarkan?*" class="btn btn-primary py-3 px-4">Wa Sekarang</a></p>
            </div>
          </div>
        </div>
      </div>
                ...
                <div class="col-md-12 d-flex align-self-stretch ftco-animate">
                  <div class="media block-6 services-wrap d-flex">
                    ...
                    <div class="media-body pl-4">
                      ...
                      <p>Hanya dengan 1,1 Jt perbualan anda sudah bisa berinvestasi tanah kavling Eksklusif siap bangun.</p>
                    </div>
                  </div>      
                </div>
                <div class="col-md-12 d-flex align-self-stretch ftco-animate">
...
<!--     <section class="ftco-section ftco-no-pt">
 ...
 <?php $this->load->view("tampilan/sales/footer/lelly")?>
