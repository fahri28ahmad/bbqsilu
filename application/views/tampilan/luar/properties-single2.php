      			...
      			<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
						  ...
						  <div class="carousel-inner">
						    <div class="carousel-item active">
						      <img src="<?php echo base_url();?>public/as/images/9/1.jpg" class="d-block w-100" alt="...">
						    </div>
						    <div class="carousel-item">
						      <img src="<?php echo base_url();?>public/as/images/9/2.jpg" class="d-block w-100" alt="...">
						    </div>
						    <div class="carousel-item">
						      <img src="<?php echo base_url();?>public/as/images/9/3.jpg" class="d-block w-100" alt="...">
						    </div>
						    <div class="carousel-item">
						      <img src="<?php echo base_url();?>public/as/images/9/4.jpg" class="d-block w-100" alt="...">
						    </div>
						    <div class="carousel-item">
						      <img src="<?php echo base_url();?>public/as/images/9/A9.jpg" class="d-block w-100" alt="...">
						    </div>
						    <div class="carousel-item">
						      <img src="<?php echo base_url();?>public/as/images/9/DAFTAR HARGA AQILA 9 PAKE DP NEW.png" class="d-block w-100" alt="...">
						    ...
						    <div class="carousel-item">
						      <img src="<?php echo base_url();?>public/as/images/9/DAFTAR HARGA AQILA 9 TANPA DP NEW.png" class="d-block w-100" alt="...">
						      <div class="carousel-caption d-none d-md-block">
						        <h5>Daftar Harga</h5>
						        <button >Cek daftar Harga</button>
						      </div>
