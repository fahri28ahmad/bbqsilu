      			...
      			<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
						  ...
						  <div class="carousel-inner">
						    <div class="carousel-item active">
						      <img src="<?php echo base_url();?>public/as/images/7/1.jpg" class="d-block w-100" alt="...">
						    </div>
						    <div class="carousel-item">
						      <img src="<?php echo base_url();?>public/as/images/7/2.jpg" class="d-block w-100" alt="...">
						    </div>
						    <div class="carousel-item">
						      <img src="<?php echo base_url();?>public/as/images/7/3.jpg" class="d-block w-100" alt="...">
						    </div>
						    <div class="carousel-item">
						      <img src="<?php echo base_url();?>public/as/images/7/4.jpg" class="d-block w-100" alt="...">
						    </div>
						    <div class="carousel-item">
						      <img src="<?php echo base_url();?>public/as/images/7/5.jpg" class="d-block w-100" alt="...">
						    </div>
						    <div class="carousel-item">
						      <img src="<?php echo base_url();?>public/as/images/7/6.jpg" class="d-block w-100" alt="...">
						    </div>
						    <div class="carousel-item">
						      <img src="<?php echo base_url();?>public/as/images/7/7.jpg" class="d-block w-100" alt="...">
						    </div>
						    <div class="carousel-item">
						      <img src="<?php echo base_url();?>public/as/images/7/8.jpg" class="d-block w-100" alt="...">
						    </div>
						    <div class="carousel-item">
						      <img src="<?php echo base_url();?>public/as/images/7/9.jpg" class="d-block w-100" alt="...">
						    </div>
						    <div class="carousel-item">
						      <img src="<?php echo base_url();?>public/as/images/7/10.jpg" class="d-block w-100" alt="...">
						    </div>
						    <div class="carousel-item">
						      <img src="<?php echo base_url();?>public/as/images/7/A7.jpg" class="d-block w-100" alt="...">
						    </div>
						    <div class="carousel-item">
						      <img src="<?php echo base_url();?>public/as/images/7/DAFTAR HARGA LOKASI 7 NEW.png" class="d-block w-100" alt="...">
						      <div class="carousel-caption d-none d-md-block">
						        <h5>Daftar Harga</h5>
						        <button >Cek daftar Harga</button>
						      </div>
						    </div>
						  </div>
