            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="<?php echo base_url();?>uang/insert_uang">
                    <div class="row">
                      <div class="col-md-12">
                          ...
                          <div class="col-sm-6">
                            <div class="input-group-prepend">
                              <span class="input-group-text">Rp</span>
                                <input type="text" onfocus="this.placeholder = ''" class="form-control" id="exampleInputName1" name="nominal" placeholder=""aria-describedby="basic-addon1"  required>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <div class="input-group-prepend">
                              <span class="input-group-text"></span>
                                <input type="text" onfocus="this.placeholder = ''" class="form-control" id="exampleInputName1" name="ket" placeholder="ket"aria-describedby="basic-addon1" required >
                            </div>
                          </div>
                        </div>
                      </div>
