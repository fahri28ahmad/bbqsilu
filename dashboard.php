        ...
        <div class="row no-gutters slider-text justify-content-center align-items-center">
          <div class="col-lg-8 col-md-6 ftco-animate d-flex align-items-end">
            <div class="text text-center w-100">
              ...
              <p><a href="https://wa.me/6281244410080?text=Halo%20.....%20Boleh%20Info%20*Tanah Kavlingnya%20 yang sedang di pasarkan?*" class="btn btn-primary py-3 px-4">Wa Sekarang</a></p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="property-wrap ftco-animate">
              ...
              <div class="text">
                <p class="price mb-3"><span class="old-price">1.500.000</span><span class="orig-price">Rp1.100.000<small>/Bulan</small></span></p>
          ...
          <div class="col-md-4">
            <div class="property-wrap ftco-animate">
              <div class="img d-flex align-items-center justify-content-center" style="background-image: url(<?php echo base_url();?>public/as/images/7/11.jpg);">
